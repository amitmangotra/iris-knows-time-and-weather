...
const timeKey = process.env.TIMEZONE_API_KEY;

service.get('/service/:location', (req, res, next) => {
    request.get('https://maps.googleapis.com/maps/api/geocode/json?address='+req.params.location+'&key='+geoKey,(err, response) => {
        if(err) {
            console.log(err);
